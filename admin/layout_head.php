...
<div class="shell">
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="<?= BASE_URL ?>/admin/blog.php" class="<?= $adminActive === 'blog' ? 'active' : '' ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/photos.php" class="<?= $adminActive === 'photos' ? 'active' : '' ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/analytics.php" class="<?= $adminActive === 'analytics' ? 'active' : '' ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/site-content.php" class="<?= $adminActive === 'site-content' ? 'active' : '' ?>">
